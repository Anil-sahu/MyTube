...
class _VideoPageState extends State<VideoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(()=>InstanceMemb.loginController.isLoading.value?Center(child: CircularProgressIndicator(color: Colors.white),)
        : Column(
          children: [
            Container(
  ...
  upload.upload(widget.file,title.text,category.text,description.text);
